...
void oscEvent(OscMessage theOscMessage) {
 if (theOscMessage.checkAddrPattern("/wek/outputs")==true) {
     if(theOscMessage.checkTypetag("fff")) { //Now looking for 2 parameters
        float p1 = theOscMessage.get(0).floatValue() /10; //get this parameter
        float p2 = theOscMessage.get(1).floatValue()/10; //get 2nd parameter
        float p3 = theOscMessage.get(2).floatValue()/10; //get third parameters
        
        //default nothing played
