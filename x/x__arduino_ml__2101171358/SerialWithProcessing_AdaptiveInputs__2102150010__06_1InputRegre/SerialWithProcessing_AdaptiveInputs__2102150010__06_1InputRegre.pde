...
// Code Extended by Guillaume D.Isabelle, 2020
// To achieve the goal of :
/*
  * Receive the Micro-Controller data from serial and transmit it to another host using OSC
*/
...
//dest = new NetAddress(giaHost,giaPort); //Send to port 6448
  dest = new NetAddress("127.0.0.1",wekinatorReceivePort); //Send to port 6448
}
...
void sendOneFeatures(String[] s,int featureToSend) {
  OscMessage msg = new OscMessage("/wek/inputs");
  StringBuilder sb = new StringBuilder();
  try {
